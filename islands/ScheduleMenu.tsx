    ...
    <>
      ...
      <div
        ...
        class={`absolute z-[999!important] ${
          agendaVisible.value
            ? "transition-transform duration-700 ease-in-out transform translate-x-0 lg:translate-x-0"
            : "transition-transform duration-500 ease-in-out transform translate-x-full hidden lg:translate-x-0"
