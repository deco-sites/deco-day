    ...
    <div class="flex h-screen w-screen">
      <div class="relative h-screen w-[50vw] overflow-clip">
        ...
        <div class="z-10">
          ...
          <input
            type="range"
            class="elem absolute border range w-32"
            min="0"
            max="100"
            value="40"
          />
          ...
          <input
            type="text"
            class="elem absolute input input-lg"
          ...
          <input
            type="checkbox"
            class="toggle toggle-lg elem absolute"
            checked
          />
          <input
            type="checkbox"
          ...
          <input
            type="checkbox"
            checked
            class="checkbox border scale-150 checkbox-lg elem absolute"
          />
          <input
            type="checkbox"
            checked
          ...
          <input
            type="radio"
            name="radio-2"
            class="radio radio-primary elem absolute rounded-full"
            checked
          />
          <input
            type="radio"
